...
PM_START_TEXT = """
ഹായ് {}, എന്റെ പേര് {}!  /help കൊടുത്താൽ മതിയാകും... 

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={}) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/sakhaavvaavaj93/pournamibot) കാണാവുന്നതാണ്...
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("അളിയാ സുഖം തന്നെയല്ലേ?")
...
@run_async
date.effective_chat  # type: Optional[Chat]
