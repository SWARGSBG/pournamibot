...
PM_START_TEXT = """
ഹായ് {}, എന്റെ പേര് {}! 
എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={@oru_bhadrakali_daasan}) ആണ് . നത് എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/sakhaavvaavaj93/pournamibot) കാണാവുന്നതാണ്...
എന്നെ ഉപയോഗിക്കാൻ ആവിശ്യമായ commandകൾ അറിയാൻ /help കൊടുത്താൽ മതിയാകും..

"""

HELP_STRINGS = """നമസ്കാരം ! എന്റെ പേര് *{}*.
...
It took lots of work for [my creator](t.me/Aniyathikutteede_Chechikutty) to get me to where I am now, and every donation helps \
